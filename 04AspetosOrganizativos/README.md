...
Antes de se comprometer a coordenar um evento de formação, defina o [público-alvo](../03SobreAprendizagemeFormacao#p%C3%BAblicos-alvo) e certifique-se de que conhece as suas necessidades. Identifique o público, qual o número máximo de participantes, quantos os formadores convidados e qual a sua área de competência. 
...
<table>
  ...
  <tr>
    <td>Garanta WiFi para os participantes</td>
    <td></td>
    <td></td>
  </tr>
  <tr>
